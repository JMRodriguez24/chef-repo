...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jmrodriguez24-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/us_jrod"
  #   chef.validation_client_name = "us_jrod-validator"
  #   chef.validation_key_path = ".chef/us_jrod-validator.pem"
  # end
end
